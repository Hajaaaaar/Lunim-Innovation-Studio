...
// ... (Props and Variants are unchanged) ...
type HeroProps = { headline?: string; subheadline?: string; primaryCtaText?: string; primaryCtaLink?: string; secondaryCtaText?: string; secondaryCtaLink?: string; };
const containerVariants = { hidden: { opacity: 0 }, visible: { opacity: 1, transition: { staggerChildren: 0.2 } } };
const itemVariants = { hidden: { y: 20, opacity: 0 }, visible: { y: 0, opacity: 1, transition: { duration: 0.6, ease: "easeOut" } } };
const images = ['/images/hero/hero-1.png', '/images/hero/hero-2.png', '/images/hero/hero-3.png'];
  ...
  return (
    <div className="relative isolate overflow-hidden">
      <AnimatePresence>
        ...
        >
          <Image src={images[currentImage]} alt="Abstract background" layout="fill" objectFit="cover" priority={true} />
        </motion.div>
      </AnimatePresence>
